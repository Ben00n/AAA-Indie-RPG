...
namespace MalbersAnimations
{
    ...
    public class MalbersInput : MInput, IInputSource
    {
        ...
        protected override void SetInput()
        {
            ...
            var NewRawInputAxis = new Vector3(horizontal, upDown, vertical);

            if (MoveCharacter && mCharacterMove != null  && NewRawInputAxis != RawInputAxis )
            {
                mCharacterMove.SetInputAxis(NewRawInputAxis);
            }

            RawInputAxis = NewRawInputAxis;
            base.SetInput();
        }
