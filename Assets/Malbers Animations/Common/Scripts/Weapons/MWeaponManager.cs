...
namespace MalbersAnimations.HAP
{
    ...
    public partial class MWeaponManager : MonoBehaviour, IAnimatorListener, IMAnimator, IMWeaponOwner, IMDamagerSet
    {
        ...
        void ConnectToInput()
        {
            ...
            if (AIM == null)
            {
                ...
                UnityEditor.Events.UnityEventTools.AddPersistentListener(AIM.OnInputChanged, m_Aim.Active_Set);
    ...
    public class MWeaponManagerEditor : Editor
    {
        ...
        private SerializedProperty
             debug, LeftHandEquipPoint, RightHandEquipPoint, UseDefaultIK, UseWeaponsOnlyWhileRiding,
        ...
        private void DrawGeneral()
        {
           ...
           //EditorGUILayout.PropertyField(StrafeOnTarget, new GUIContent("Strafe on Target/Aim", "If is The Rider is aiming or has a Target:\nThe Character will be set to Strafe"));
            ...
            UseWeaponsOnlyWhileRiding.boolValue = GUILayout.Toggle(UseWeaponsOnlyWhileRiding.boolValue, new GUIContent("Use Weapons only while Riding", "The Weapons can only be used with the Riding System"));
        }
        ...
        private void DrawAdvanced()
        {
            EditorGUILayout.BeginVertical(EditorStyles.helpBox);
            {
                ...
                UseDefaultIK.boolValue = GUILayout.Toggle(UseDefaultIK.boolValue, new GUIContent(" Default IK", "Weapon Manager uses Default Unity IK, Disable this if you are going to use The Animation Rigging Package or any 3rd Party IK Solution"));
            }
            EditorGUILayout.EndVertical();
        }
