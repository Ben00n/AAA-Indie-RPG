...
namespace MalbersAnimations.HAP
{
    ...
    public class MRider : MonoBehaviour, IAnimatorListener, IRider
    {
        ...
        public Mount MountStored => m_MountStored.Value != null ? m_MountStored.Value.GetComponent<Mount>() : null;
...
/// <summary> Speed Multiplier for the Speeds Changes while using other Animals</summary>
        public float SpeedMultiplier// { get; set; }
        {
            ...
            protected set
            {
                ...
                Debug.Log("speedMultiplier: " + speedMultiplier);                         //Update Mount Parameter on the Animator
            }
        }
        ...
        public virtual void CallAnimal(bool call)
        {
            ...
            if (CanCallAnimal && mountStored)
            {
                if (m_MountStored.Value.IsPrefab())
                {
                    ...
                    ToggleCall = false;
                    MountStored.AI = InsMount.FindInterface<IAIControl>();
    ...
    //    private MonoScript script;
        ...
        /*  CreateColliderMounted,   Col_Center, Col_height, Col_radius, Col_Trigger,*/ CallAnimalA, StopAnimalA, RiderAudio, LeftHand, RightHand,
