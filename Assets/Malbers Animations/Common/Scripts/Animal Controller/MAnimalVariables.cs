    ...
    public partial class MAnimal
    {
        ...
        public State ActiveState
        {
            ...
            internal set
            {
                ...
                Sprint = sprint; //Check Again the sprint everytime a new state is active IMPORTANT
            }
        }
        ...
        public Vector3 DirectionalVelocity { get; internal set; }
...
[SerializeField] private BoolReference SmoothVertical = new BoolReference(true);
    ...
    /// <summary>Does it have a Hip Pivot?</summary>
        ...
        /// <summary>The full Velocity we want to without lerping, for the Additional Position</summary>
        public Vector3 TargetSpeed
        {
            get
            {
                Vector3 TargetDir = DirectionalVelocity * SmoothZY;
                ...
                if (VerticalSmooth < 0 && !Strafe)
                {
                    ...
                    {
                        TargetDir *= -CurrentSpeedSet.BackSpeedMult.Value;  //Decrease half when going backwards
                ...
                Debug.DrawRay(transform.position+additivePosition, ts*5, Color.green);
