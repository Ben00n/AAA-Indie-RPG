...
namespace MalbersAnimations.Controller
{
    ...
    public class MAnimalAIControl : MonoBehaviour, IAIControl, IAITarget, IAnimatorListener
    {
               ...
               // MoveAgent = MoveAgentOnMovingTarget;
                ...
                if (MoveAgentOnMovingTarget)
                {
                    if (!MoveAgent)
                        ...
                        Agent.SetDestination(DestinationPosition);  //Only Resume the Agent in case the Animal is set to move on moving Target.
                }
            }
        }
        ...
        /// <summary>Remove the current Target and </summary>
                ...
                if (OMLData.linkType == OffMeshLinkType.LinkTypeManual)              //Means that it has a OffMesh Link component
                {
                    ...
                    if (CurrentOML)
                    {
                        ...
                        if (IsOffMeshZone)                                               //if the OffmeshLink is a zone and is not making an action
                        {
                            ...
                            IsOffMeshZone.ActivateZone();                            //Activate the Zone
                            return;
                        }
                        ...
                        {
                            Debuging($"<color=white>is On a <b>[OffmeshLink]</b> -> [Climb]</color>");
